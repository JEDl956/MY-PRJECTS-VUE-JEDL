  ...
  <article class="card card-hover group relative flex flex-col gap-3 p-5">
    ...
    <div class="flex items-start justify-between gap-3">
      <div class="flex min-w-0 flex-col gap-1">
        ...
        <p
          v-else
          class="text-sm italic text-text-3"
        >
          No description
        </p>
      </div>
      ...
      <div
        class="relative z-10 flex shrink-0 gap-1 opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100"
      >
        <button
          type="button"
